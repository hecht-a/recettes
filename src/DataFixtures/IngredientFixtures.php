...
class IngredientFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $units = [
            ...
            'pièce(s)' => UnitFactory::find(['shortLabel' => 'pièce(s)']),
        ];

        $ingredients = [
            ['name' => 'Tomate', 'description' => 'Fruit souvent utilisé comme légume, incontournable dans les salades et les sauces.', 'unit' => $units['pièce(s)']],
            ['name' => 'Carotte', 'description' => 'Légume-racine riche en bêta-carotène, souvent consommé cru ou cuit.', 'unit' => $units['pièce(s)']],
            ...
            ['name' => 'Oignon', 'description' => 'Aromate essentiel pour de nombreuses recettes, utilisé cru ou cuit.', 'unit' => $units['pièce(s)']],
            ['name' => 'Ail', 'description' => 'Aromate puissant, souvent utilisé pour relever les plats.', 'unit' => $units['pièce(s)']],
            ...
            ['name' => 'Oeuf', 'description' => 'Ingrédient essentiel pour la pâtisserie et de nombreux plats salés.', 'unit' => $units['pièce(s)']],
